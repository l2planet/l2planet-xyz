...
{#if isOpen}
    ...
    <div class="animated md:hidden fixed left-0 top-16 flex flex-col p-7 gap-y-2 w-full h-[calc(100vh-4rem)] bg-white/10 backdrop-blur-lg">
